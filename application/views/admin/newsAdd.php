    ...
    <div id="templatemo_main">
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="title" class="text" />
<?php echo form_error('title'); ?>
				</td>
			</tr>
			<tr>
				<td valign="top">Text<span style="color:red;">*</span></td>
				<td><Textarea name="text" class="text" >
			...
			<tr>
				...
				<td><input type="text" name="author" class="text" />
<?php echo form_error('author'); ?>
			...
			<tr>
				...
				<td><input type="text" name="date" onclick="displayDatePicker('date');" class="text" />
...
<?php echo form_error('date'); ?></td>
			...
			<tr>
				...
				<td><Textarea name="src" class="text" ></Textarea><?php echo form_error('src'); ?>
