...
<?php include "user_template/header.php"?>
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            ...
            <li><?php echo anchor('ecommerce/member_product', 'Produk' );?></li>
            ...
            <li><?php echo anchor('ecommerce/member_contact', 'Contact Us', array('class'=>'selected'));?></li>
	...
	<?php include "user_template/sidebarin.php"?>
	 <div id="content">
            ...
            <p>Etiam eget leo nisl. Morbi magna enim, lobortis vitae condimentum. Validate <a href="http://validator.w3.org/check?uri=referer" rel=
			"nofollow">XHTML</a> &amp; <a href="http://jigsaw.w3.org/css-validator/check/referer" rel="nofollow">CSS</a>.</p>
            <div id="contact_form">
